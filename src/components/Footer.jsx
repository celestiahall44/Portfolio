  ...
  return (
    <footer className={styles.footer} id="contact">
      <div className={styles.socials}>
        <a href="https://github.com/your-github" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className={styles.icon}>
        ...
        <a href="https://linkedin.com/in/your-linkedin" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className={styles.icon}>
        ...
        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" aria-label="Resume" className={styles.icon}>
      ...
      <p>&copy; 2026 Celestia. All rights reserved.</p>
    </footer>
  );
}
